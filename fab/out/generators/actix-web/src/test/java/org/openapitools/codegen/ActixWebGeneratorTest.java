 ...
 * 1) Set a break point in ActixWebGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class ActixWebGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("actix-web") // use this codegen library
              ...
              .setOutputDir("out/actix-web"); // output directory
